 ...
 */
final class Version20260214162025 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE platform_fee (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, tontine_id INT DEFAULT NULL, amount NUMERIC(15, 2) NOT NULL, type VARCHAR(50) NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', transaction_id VARCHAR(100) DEFAULT NULL, INDEX IDX_206F96A6A76ED395 (user_id), INDEX IDX_206F96A6DEB5C9FD (tontine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tontine (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, tontine_code VARCHAR(255) DEFAULT NULL, amount_per_point NUMERIC(15, 2) DEFAULT NULL, total_points INT DEFAULT NULL, frequency VARCHAR(255) DEFAULT NULL, start_date DATE DEFAULT NULL, next_due_date DATE DEFAULT NULL, reminder_enabled TINYINT(1) DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ended_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', name VARCHAR(255) DEFAULT NULL, total_pay NUMERIC(15, 2) DEFAULT NULL, frais_preleves TINYINT(1) NOT NULL, paid_fees INT DEFAULT 0 NOT NULL, INDEX IDX_3F164B7FFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
